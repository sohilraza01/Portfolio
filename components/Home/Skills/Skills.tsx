      ...
      <div className="flex flex-wrap justify-center gap-6 mt-16">
        {skills.map((skill,i)=>{
            return <Tilt key={skill.name} scale={1.5} transitionSpeed={400}>
                <div data-aos='flip-right' data-aos-anchor-placement='top-center' daa-aos-delay={i*100}
                 className="bg-[#14134145] text-center w-40 h-48 rounded-3xl flex flex-col justify-center items-center shadow-lg transition hover:scale-105">
